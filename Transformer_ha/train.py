...
if __name__ == "__main__":
    ...
    parser.add_argument('--phage_embed', type=str, default='/eagle/MDClimSim/tungnd/data/bio/embeddings/phage_embeddings/', help="path to phage embeddings folder")
    parser.add_argument('--host_embed', type=str, default='/eagle/MDClimSim/tungnd/data/bio/embeddings/host_embeddings/', help="path to host embeddings folder")
    parser.add_argument('--train_positive_fn', type=str, default='/eagle/MDClimSim/tungnd/data/bio/ecoli_metadata/round_0/train_positive_pairs.txt',
                        help="path to positive pairs")
    parser.add_argument('--train_negative_fn', type=str, default='/eagle/MDClimSim/tungnd/data/bio/ecoli_metadata/round_0/train_negative_pairs.txt', help="path to negative pairs")
    ...
    parser.add_argument("--max_len", type=int, default=2100, help="Maximum sequence length")
    ...
    parser.add_argument("--root_dir", type=str, default='/eagle/MDClimSim/tungnd/bio/', help="Exp root directory")
