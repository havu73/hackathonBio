...
* [**K-mer baseline:**](https://github.com/havu73/hackathonBio/blob/main/explorationHa/PB-LKS) We used PB-LKS as a baseline prediction model to compare against our team's model. It is developed by [Qui et al., 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC10859729/), and uses k-mer frequency counting as the basis for feature extraction. 
